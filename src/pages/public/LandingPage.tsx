        ...
        <CardContent className="space-y-4 p-6">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="rounded-xl bg-brand-tint px-3 py-2 text-right">
              ...
              <div className="text-lg font-bold text-ink-deep">Rs 1,196</div>
            </div>
          </div>
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted">
                Register as a customer to shop and track your orders. Admin accounts are only created by authorized super admins.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Card className="border-line-strong bg-card/80 backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md">
                <CardContent className="p-5">
                  ...
                  <div className="text-sm font-semibold text-ink-strong">For admins</div>
                  <div className="mt-1 text-xs text-muted">Admins should contact a super admin to get an account.</div>
