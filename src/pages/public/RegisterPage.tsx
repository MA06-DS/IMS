    ...
    <form
      ...
      onSubmit={form.handleSubmit(async (values) => {
        try {
          ...
          const username = (res as any)?.user?.username ?? 'your account'
      ...
      <div className="grid w-full items-start gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="mt-8">
            <Card className="border-line-strong bg-brand-tint">
              <CardContent className="p-5">
                ...
                <div className="mt-1 text-sm font-semibold text-ink-strong">Create a shopping account to browse, order, and track delivery.</div>
              </CardContent>
            </Card>
          </div>
        ...
        <Card className="mx-auto w-full max-w-[480px] rounded-2xl">
          <CardHeader className="items-center text-center">
            ...
            <CardDescription>
              Register as a customer to shop and track your orders.{' '}
              <Link to="/login" className="font-semibold text-brand hover:underline">
                Sign in instead
              </Link>
            </CardDescription>
