          ...
          <CardContent>
            <DataTable
              ...
              columns={[
                ...
                { key: 'items', header: 'Items', cell: (r) => <span className="text-muted">{r.itemCount ?? (r.items ?? []).length}</span> },
                { key: 'total', header: 'Total', cell: (r) => <span className="font-medium">{formatCurrency(r.totalAmount ?? 0)}</span> },
