          ...
          <CardContent className="p-0">
            <DataTable
              ...
              columns={[
                ...
                { key: 'items',    header: 'Items',    cell: (r) => <span className="text-sm text-muted">{r.itemCount ?? (r.items ?? []).length}</span> },
                { key: 'total',    header: 'Total',    cell: (r) => <span className="text-sm font-semibold">{formatCurrency(r.totalAmount ?? 0)}</span> },
