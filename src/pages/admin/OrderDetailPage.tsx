  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={
          order.data?.datetime ? `Placed: ${formatDateTime(order.data.datetime)}` : undefined
        }
        actions={
          ...
          <Card className="lg:col-span-2">
            ...
            <CardContent className="space-y-3">
              {(order.data.items ?? []).map((i) => (
                <div
                  key={`${i.orderId}-${i.productId}`}
                  className="flex items-start justify-between gap-3 rounded-xl border border-line bg-page p-4"
                >
          ...
          <div className="space-y-4">
              ...
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setStatus.mutate(v as OrderStatus)}
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted">
                Status history is stubbed in frontend; backend can provide an events table for a
                full timeline.
              </CardContent>
            </Card>
          </div>
